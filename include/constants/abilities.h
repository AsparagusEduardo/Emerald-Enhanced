...
//custom abilities
#define ABILITY_ILLUSIONIST     (ABILITIES_COUNT_GEN8 + 0)
#define ABILITY_PRIMAL          (ABILITIES_COUNT_GEN8 + 1)
#define ABILITY_STEELY_RESOLVE  (ABILITIES_COUNT_GEN8 + 2)
#define ABILITY_FIERCE_KICKS    (ABILITIES_COUNT_GEN8 + 3)
#define ABILITY_ARMORED         (ABILITIES_COUNT_GEN8 + 4)
#define ABILITY_DETONATE        (ABILITIES_COUNT_GEN8 + 5)
#define ABILITY_GLACIAL         (ABILITIES_COUNT_GEN8 + 6)
#define ABILITY_VAMPIRIC        (ABILITIES_COUNT_GEN8 + 7)
#define ABILITY_HARBINGER       (ABILITIES_COUNT_GEN8 + 8)
#define ABILITY_GREATWOOD       (ABILITIES_COUNT_GEN8 + 9)
#define ABILITY_VOODOO          (ABILITIES_COUNT_GEN8 + 10)
#define ABILITY_ICEWORKER       (ABILITIES_COUNT_GEN8 + 11)
#define ABILITY_PLAGUEBEARER    (ABILITIES_COUNT_GEN8 + 12)
#define ABILITY_CACOPHONY       (ABILITIES_COUNT_GEN8 + 13)

#define ABILITIES_COUNT_CUSTOM  (ABILITIES_COUNT_GEN8 + 13)
