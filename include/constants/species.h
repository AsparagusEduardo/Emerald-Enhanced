...
#define IS_MEGA_EVOLVED(speciesId) ((speciesId >= SPECIES_VENUSAUR_MEGA) && (speciesId <= SPECIES_RAYQUAZA_MEGA))
#define NUMBER_OF_MEGAS (SPECIES_RAYQUAZA_MEGA - SPECIES_VENUSAUR_MEGA + 1)
...
#define SPECIES_UNOWN_SCHOOL                 FORMS_START + 309
#define SPECIES_ONIX_CRYSTAL                 FORMS_START + 310

#define SPECIES_EGG SPECIES_ONIX_CRYSTAL + 1
