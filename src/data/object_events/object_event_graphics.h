...
const u16 gObjectEventPal_DawnNormal[] = INCBIN_U16("graphics/object_events/pics/people/dawn/dawn.gbapal");
...
const u16 gObjectEventPal_Lusamine[] = INCBIN_U16("graphics/object_events/palettes/lusamine.gbapal");
